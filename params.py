...
class P(object):
    ...
    def set_pi(cls, pi):
        ...
        #cls.seed = cls.getp("seed", opt.seed)
        ...
        #cls.assoc_lesion_type = cls.getp("ASSOC_LESION_TYPE", default="none")
        #cls.assoc_lesion_strength = cls.getp("ASSOC_LESION_STRENGTH", default=0.0)
        cls.phonetic_lesion_type = cls.getp("PHONETIC_LESION_TYPE", default="none")
        #cls.phonetic_lesion_strength = cls.getp("PHONETIC_LESION_STRENGTH", default=0.0)
        ...
        #treatment_run treatment_language treatment_time ntreatment_words treatment_sem_factor treatment_alpha_factor treatment_leak_factor treatment_seed
...
class T(object):
    ...
    def set_ti(cls, ti):
        ...
        #cls.fake_assoc_pre_years =  cls.getp("fake_assoc_pre_years", 0.0)
        ...
        #cls.leak_train_map_nmax =  cls.getp("leak_train_map_nmax",)  ### not doing that yet
        #cls.leak_train_map_nmax_sigma =  cls.getp("leak_train_map_nmax_sigma", 5.0)
